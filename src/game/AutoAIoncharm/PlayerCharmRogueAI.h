...
class MANGOS_DLL_SPEC PlayerCharmRogueAI
{
    public:
		PlayerCharmRogueAI();
		void RogueAI(Player* pPlayer);
		void SpellRogue(Player* pPlayer);
...
#define Rogue MaNGOS::Singleton<PlayerCharmRogueAI>::Instance()