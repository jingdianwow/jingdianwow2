...
class MANGOS_DLL_SPEC PlayerCharmHunterAI
{
    public:
		PlayerCharmHunterAI();
		void HunterAI(Player* pPlayer);
		void SpellHunter(Player* pPlayer);
...
#define Hunter MaNGOS::Singleton<PlayerCharmHunterAI>::Instance()