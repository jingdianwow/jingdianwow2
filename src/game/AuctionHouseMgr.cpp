...
AuctionHouseEntry const* AuctionHouseMgr::GetAuctionHouseEntry(Unit* unit)
{
    ...
    if (!sWorld.getConfig(CONFIG_BOOL_ALLOW_TWO_SIDE_INTERACTION_AUCTION))
    {
        if (unit->GetTypeId() == TYPEID_UNIT)
        {
            ...
            {
                case   12: houseid = 7; break;              // human
                case   29: houseid = 7; break;              // orc, and generic for horde
                case   55: houseid = 7; break;              // dwarf/gnome, and generic for alliance
                case   68: houseid = 7; break;              // undead
                case   80: houseid = 7; break;              // n-elf
                case  104: houseid = 7; break;              // trolls
                case  120: houseid = 7; break;              // booty bay, neutral
                case  474: houseid = 7; break;              // gadgetzan, neutral
                case  534: houseid = 7; break;              // Alliance Generic
                ...
                default:                                    // for unknown case
                {
                    ...
                    if (!u_entry)
                        ...
                        houseid = 7;                        // human auction house
                    else if (u_entry->ourMask & FACTION_MASK_HORDE)
                        houseid = 7;                        // orc auction house
                    else
                        houseid = 7;                        // goblin auction house
                    break;
                }
