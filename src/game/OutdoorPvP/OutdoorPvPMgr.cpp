...
#include "OutdoorFB/Hsts/OutdoorPvPTS.h"
#include "OutdoorFB/Zug/OutdoorPvPZG.h"
#include "OutdoorFB/Fx/OutdoorPvPFX.h"
#include "XinrenBuff/OutdoorPvPEY.h"
...
OutdoorPvP* OutdoorPvPMgr::GetScript(uint32 zoneId)
{
    switch (zoneId)
    {
		...
		case ZONE_ID_BUFF_TS:
			return m_scripts[OPVP_ID_TS];
		case ZONE_ID_BUFF_ZG:
			return m_scripts[OPVP_ID_ZG];
		case ZONE_ID_BUFF_FX:
			return m_scripts[OPVP_ID_FX];
		case ZONE_ID_BUFF_EY:
			return m_scripts[OPVP_ID_EY];
        default:
            return NULL;
    }
}
