			...
			if (Spell* spell = target->GetCurrentSpell(CURRENT_GENERIC_SPELL))
			{
				if (spell->m_CastItem)
				{
					...
					case 30189:
						...
						return;
					case 30190:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 11909;
						target->SetDisplayId(11909);
						return;
					case 30191:
					...
					case 30198:
						...
						return;
					case 30199:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 7922;
						target->SetDisplayId(7922);
						return;
					case 33013:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 2029;
						target->SetDisplayId(2029);
						return;
					case 33014:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 825;
						target->SetDisplayId(825);
						return;
					case 33015:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 11070;
						target->SetDisplayId(11070);
						return;
					case 33016:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 4214;
						target->SetDisplayId(4214);
						return;
					case 33017:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 2041;
						target->SetDisplayId(2041);
						return;
					case 33018:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 2042;
						target->SetDisplayId(2042);
						return;
					case 33019:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 6434;
						target->SetDisplayId(6434);
						return;
					case 33020:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 8055;
						target->SetDisplayId(8055);
						return;
					case 33021:
						...
						return;
					case 33022:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 9778;
						target->SetDisplayId(9778);
						return;
					case 33023:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 10674;
						target->SetDisplayId(10674);
						return;
					case 33024:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 11429;
						target->SetDisplayId(11429);
						return;
					case 33025:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 15419;
						target->SetDisplayId(15419);
						return;
					case 33026:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 15420;
						target->SetDisplayId(15420);
						return;
					case 33027:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 657;
						target->SetDisplayId(657);
						return;
					case 33028:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 16582;
						target->SetDisplayId(16582);
					...
					case 33029:
						...
						return;
					case 33030:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 6781;
						target->SetDisplayId(6781);
						return;
					case 33031:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 2722;
						target->SetDisplayId(2722);
						return;
					case 33032:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 4731;
						target->SetDisplayId(4731);
						return;
					case 33033:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 15311;
						target->SetDisplayId(15311);
						return;
					case 33034:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 8807;
						target->SetDisplayId(8807);
					...
					case 33035:
						...
						return;
					case 33036:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 16028;
						target->SetDisplayId(16028);
						return;
					case 33037:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 15990;
						target->SetDisplayId(15990);
						return;
					case 33038:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 14752;
						target->SetDisplayId(14752);
						return;
					case 33039:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 16104;
						target->SetDisplayId(16104);
						return;
					case 33040:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 15320;
						target->SetDisplayId(15320); 
						return;
					case 33041:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 11655;
						target->SetDisplayId(11655);
							return;
					case 33042:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 15940;
						target->SetDisplayId(15940);
						return;
					case 33043:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 5299;
						target->SetDisplayId(5299);
						return;
					case 33044:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 11396;
						target->SetDisplayId(11396);
						return;
					case 33045:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 14589;
						target->SetDisplayId(14589);
						return;
					case 33046:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 14792;
						target->SetDisplayId(14792);
						return;
					case 33047:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 16164;
						target->SetDisplayId(16164);
						return;
					case 33048:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 10729;
						target->SetDisplayId(10729);
						return;
					case 33049:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 14701;
						target->SetDisplayId(14701);
						return;
					case 33050:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 16611;
						target->SetDisplayId(16611);
						return;
					case 33051:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 10445;
						target->SetDisplayId(10445);
						return;
					case 33052:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 10089;
						target->SetDisplayId(10089);
						return;
					case 33053:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 10214;
						target->SetDisplayId(10214);
						return;
					case 33054:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 4162;
						target->SetDisplayId(4162);
						return;
					case 33055:
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 7592;
						target->SetDisplayId(7592);
						return;
					case 33056://ËÑÑ°Õß¿ËÂÞÎ¬¶û
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 14452;
						target->SetDisplayId(14452);
						return;
					case 33057://¹¾ßó
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 15984;
						target->SetDisplayId(15984);
						return;
					case 33058://ºÚ°µÕ½Ê¿
						((Player*)target)->m_Player_ModelId[PLAYER_MODELID] = 16534;
						target->SetDisplayId(16534);
						return;
					default:
						break;
					}
