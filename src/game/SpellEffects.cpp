...
void Spell::EffectHeal(SpellEffectIndex /*eff_idx*/)
{
    if (unitTarget && unitTarget->isAlive() && damage >= 0)
    {
        ...
        if (m_spellInfo->Id == 18562)
        {
			...
			if (targetAura->GetSpellProto()->SpellFamilyFlags & UI64LIT(0x0000000000000040))        // 修复技能-迅捷治愈
			{
				tickcount -= 1;
			}
	...
	if (m_CastItem)
	{
		...
		case 103010://BWL
			if (_player->GetMapId() != 469)
				_player->UnbindInstance(469);
			break;
		case 103011://MC
			if (_player->GetMapId() != 409)
				_player->UnbindInstance(409);
			break;
		case 103012://ZUG
			if (_player->GetMapId() != 309)
				_player->UnbindInstance(309);
			break;
		case 103013://FX
			if (_player->GetMapId() != 509)
				_player->UnbindInstance(509);
			break;
		case 103080://Onikxy
