...
bool Totem::IsImmuneToSpellEffect(SpellEntry const* spellInfo, SpellEffectIndex index, bool castOnSelf) const
{
	...
	if (GetEntry() == 5925 && isAlive())
	{
		if (HasAura(8178) || HasAura(8179))
		{
			((Creature*)this)->RemoveAurasDueToSpell(8178);
			((Creature*)this)->RemoveAurasDueToSpell(8179);
			((Creature*)this)->CastSpell(((Creature*)this), 8179, true);
		}
	}
