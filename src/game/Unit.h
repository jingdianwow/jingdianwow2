...
class MANGOS_DLL_SPEC Unit : public WorldObject
{
    public:
         ...
         */
		void ApplyDiminishingToDuration(DiminishingGroup  group, int32& duration, Unit* caster, DiminishingLevels Level, bool isReflected, const SpellEntry* spellInfo);
        /**
		...
		void SetRace(int32 val) { SetByteValue(UNIT_FIELD_BYTES_0, 0, val); }
		void SetClass(int32 val) { SetByteValue(UNIT_FIELD_BYTES_0, 1, val); }
		...
		void DealDamageMods(Unit* pVictim, uint32& damage, uint32* absorb, bool critical = false);
		...
		bool DoubleCheckAccess(Creature const* c) const;
		...
		void RemoveAura(uint32 spellId, SpellEffectIndex effindex, ObjectGuid casterGuid, Aura* except = NULL);
